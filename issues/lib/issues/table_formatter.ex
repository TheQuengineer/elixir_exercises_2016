defmodule Issues.TableFormatter do
  ...
  a list containing lists of the data in each column, The `headers` parameter contains
  ...
  @doc """
  Given a list containing sublists, where each sublis contains the data for a
